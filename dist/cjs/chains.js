...
exports.isSolana = exports.isEvm = exports.isSupportedChain = exports.SupportedChains = exports.NetworkEnum = void 0;
var NetworkEnum;
(function (NetworkEnum) {
    ...
    NetworkEnum[NetworkEnum["MONAD"] = 10143] = "MONAD";
...
const isEvm = (chain) => {
    return (exports.SupportedChains.includes(chain) &&
